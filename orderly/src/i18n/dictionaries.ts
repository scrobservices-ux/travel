...
export const en = {
  ...
  invoices: { title: "Invoices", newViaAgent: "New via agent", number: "Number", client: "Client", issued: "Issued", vat: "VAT", total: "Total incl. VAT", status: "Status", empty: "No invoices yet — ask the invoicing agent to create one." },
  ...
  documents: { title: "Documents", sub: "Everything read, classified and filed by the documents agent.", empty: "No documents yet. Upload files or connect your inbox, then let the documents agent process them." },
...
export const fr: Dictionary = {
  ...
  invoices: { title: "Factures", newViaAgent: "Nouvelle via agent", number: "Numéro", client: "Client", issued: "Émise", vat: "TVA", total: "Total TTC", status: "Statut", empty: "Aucune facture — demandez à l'agent de facturation d'en créer une." },
  ...
  documents: { title: "Documents", sub: "Tout ce qui a été lu, classé et rangé par l'agent documents.", empty: "Aucun document. Importez des fichiers ou connectez votre boîte mail, puis laissez l'agent documents les traiter." },
