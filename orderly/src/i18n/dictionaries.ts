...
export const en = {
  ...
  appNav: { overview: "Overview", agents: "Agents", approvals: "Approvals", invoices: "Invoices", received: "Received", bookkeeping: "Bookkeeping", documents: "Documents", scheduling: "Scheduling", settings: "Settings" },
  received: { title: "Received invoices", sub: "Supplier e-invoices you receive (Factur-X / CII / UBL), parsed and filed. Reception is mandatory for all French businesses from 1 Sept 2026.", upload: "Import e-invoice", uploading: "Reading…", uploadHint: "Factur-X PDF or CII/UBL XML — Orderly reads it.", recordExpense: "Also record as expense", supplier: "Supplier", number: "Number", date: "Date", ttc: "Total incl. VAT", empty: "No received invoices yet. Import a supplier's Factur-X PDF or XML.", ereporting: "Export e-reporting (CSV)" },
  ...
  invoices: { title: "Invoices", newViaAgent: "New via agent", number: "Number", client: "Client", issued: "Issued", vat: "VAT", total: "Total incl. VAT", status: "Status", pdf: "Factur-X", efacture: "E-invoice", transmit: "Transmit", transmitting: "Transmitting…", empty: "No invoices yet — ask the invoicing agent to create one." },
...
export const fr: Dictionary = {
  ...
  appNav: { overview: "Vue d'ensemble", agents: "Agents", approvals: "Approbations", invoices: "Factures", received: "Reçues", bookkeeping: "Comptabilité", documents: "Documents", scheduling: "Agenda", settings: "Paramètres" },
  received: { title: "Factures reçues", sub: "Les e-factures fournisseurs que vous recevez (Factur-X / CII / UBL), analysées et classées. La réception est obligatoire pour toutes les entreprises françaises dès le 1er septembre 2026.", upload: "Importer une e-facture", uploading: "Lecture…", uploadHint: "PDF Factur-X ou XML CII/UBL — Orderly le lit.", recordExpense: "Enregistrer aussi en dépense", supplier: "Fournisseur", number: "Numéro", date: "Date", ttc: "Total TTC", empty: "Aucune facture reçue. Importez le PDF Factur-X ou le XML d'un fournisseur.", ereporting: "Exporter l'e-reporting (CSV)" },
  ...
  invoices: { title: "Factures", newViaAgent: "Nouvelle via agent", number: "Numéro", client: "Client", issued: "Émise", vat: "TVA", total: "Total TTC", status: "Statut", pdf: "Factur-X", efacture: "E-facture", transmit: "Transmettre", transmitting: "Transmission…", empty: "Aucune facture — demandez à l'agent de facturation d'en créer une." },
